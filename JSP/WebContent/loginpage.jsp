...
<body>
	<%
		...
		try{
			...
			String selectQuery = "select username, password from employee_table where userName='"+userName+"'";
			...
			if(employee.getUserName().equals(database_userName)){
				if(employee.getPassword().equals(database_password)){
					...
					dispatcher = request.getRequestDispatcher("medicine-search.html");
					dispatcher.forward(request, response);
				}
				else{
					dispatcher = request.getRequestDispatcher("login-validation.html");
